...
class Post {
  ...
  factory Post.fromJson(Map<String, dynamic> json) {
    return Post(
      id: json['id'],
      userId: json['userId'] ?? 1, // Nilai default jika null
      title: json['title'],
      body: json['body'],
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> createPost(String title, String body) async {
    ...
    try {
      ...
      // Status code 201 menandakan sukses create
  ...
  // 2. UPDATE POST (Langkah m)
  Future<void> updatePost(int id, String title, String body) async {
    // Ganti URL agar selalu menunjuk ke ID 1 untuk demo ini (keterbatasan API dummy)
  ...
  // Dialog Konfirmasi Hapus (Langkah r)
  ...
  // --- BUILD UI (Langkah k & o) ---
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Demo CRUD client-server')),
      body: Center(
        // Kondisi: Jika createdPost null (belum ada data), tampilkan Text
        // Jika ada data, tampilkan Card
